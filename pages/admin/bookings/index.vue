<template lang="html">
  <div class="bookings-wrapper">
      ...
      <div v-if="!loading">
          <div class="bookings" v-if="bookings.length !== 0">
            <div class="booking" v-for="booking in bookings" :key="booking.id">
                <div class="booking-content">
                  <h4 class="booking-name">{{booking.name}}</h4>
                  ...
                  <div class="booked-unit">
                    <h4>Booked Unit:</h4>
                    <p>{{booking.unit}}</p>
                    <p v-if="booking.unit == '2 Bedroom'">(57 Sqm)</p>
                    <p v-if="booking.unit == '3 Bedroom'">(74.5 Sqm)</p>
                  </div>
