  ...
  <div class="footer-section">
      <div class="footer-section-container">
        <div class="footer-intro">
            ...
            <div class="footer-intro-background">
            </div>
        </div>
...
<style lang="scss" scoped>
    ...
    h1,h2,h3,h4,h5,h5,li,p, ::placeholder, label, textarea, input{
  ...
  .footer-section{
    ...
    .footer-section-container{
      ...
      .footer-intro{
        ...
        .footer-intro-background{
          position: absolute;
          bottom:0;
          width:100%;
          height: 100%;
          background-position: bottom center;
          background-image: url('/svg/house-plan.svg');
